...
function DashboardCards() {
  ...
  const [vendor, setVendor] = useState([]);
    ...
    const fetchVendor = async () => {
        try {
            const response = await axios.get(`${baseUrl}/user/filterUser/64548fe503361d235e13f849`);
  ...
  const [users, setUsers] = useState([]);
    ...
    const fetchUsers = async () => {
        try {
            const response = await axios.get(`${baseUrl}/user/filterUser/64548ff003361d235e13f84a`);
    ...
    <>
      ...
      <div className='row '>
        <div className='col-3'>
          ...
          {/* <p className='float-end pt-3'>3</p> */}
